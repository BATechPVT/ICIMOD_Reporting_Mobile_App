...
declare let __example_plugin:   undefined;
declare let __example_plugin_swift:  undefined;
...
export function examplePluginSwift(frame: Frame): string[] {
  ...
  return (frame, 'hello!', 'parameter2', true, 42, { test: 0, second: 'test' }, ['another test', 5]);
}
