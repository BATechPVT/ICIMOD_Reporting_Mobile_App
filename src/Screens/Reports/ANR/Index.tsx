...
export default function AnrReportDashBoard(props: any) {
  ...
  const fetchData = async () => {
    const apiResponse = await post(GET_ANR_SITES, {});
      ...
      >
        ...
        >
          ...
          >
            ...
            <Text style={{ flex: 1 }}>
              {": " + section.areaofEnclosure + " " + Unit(section?.areaUnit)}
            </Text>
          </View>
          <View
            style={{
          ...
          <TouchableOpacity
            onPress={() =>
              props.navigation.navigate("AnrReportDetail", {
                item: section,
                reportType,
              })
            }
