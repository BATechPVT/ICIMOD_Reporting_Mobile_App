...
export default function NurseriesDetail(props: any) {
  ...
  const rowItems = [
    ...
    {
      title: "Province",
      value: item.forestDivision.name,
    },
    {
      title: "District",
    ...
    {
      title: "Tehsil",
      value: item.tehsil.name,
    },
    {
      title: "Nursery Stock",
      value: item.nurseryStock,
    },

    {
      title: "Establish Date",
      value: moment.utc(item?.establishDate).fromNow(),
    },
    {
      title: "Area",
